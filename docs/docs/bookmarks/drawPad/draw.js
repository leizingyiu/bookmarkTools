data: text / html, <html>
  ...
  <body style='margin:0;'>
    ...
    <script>
      ...
      var c1 = [255, 255, 255], c2 = [196, 196, 196], brushWeight = 1;
      var beforeX, beforeY;
      function setup() {
      ...
      fill(...c1);
      circle(windowWidth - 100, windowHeight - 100, brushWeight);

      brushWeight += event.delta / 10;
      console.log(brushWeight);
      brushWeight = brushWeight < 0 ? 1 : brushWeight;
    brushWeight = brushWeight > 100 ? 100 : brushWeight;
