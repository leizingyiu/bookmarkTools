javascript: (function() {
	...
	p.innerHTML = str;
    p.id='yiu_tbPriceList';
/*    p.style.whiteSpace='nowrap';*/
    var s=document.createElement('style');
    s.innerText='#yiu_tbPriceList{white-space: nowrap;    position: absolute;    left: 0;    top: 0;    z-index: 999;    width: 340px;    background: #fdfdfd;    padding: 1em;} #yiu_tbPriceList tr:hover{    background: #fff4db;}'
    
document.querySelector('.tb-sidebar,#ald-skuRight').style.position= 'relative';
document.querySelector('.tb-sidebar,#ald-skuRight').insertBefore(p, document.querySelector('.tb-sidebar,#ald-skuRight').children[0]);
document.querySelector('.tb-sidebar,#ald-skuRight').insertBefore(s, document.querySelector('.tb-sidebar,#ald-skuRight').children[0]);
})()
